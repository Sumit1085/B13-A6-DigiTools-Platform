...
const Banner = () => {
    return (
        <div className='container mx-auto'>
            <div className='mt-22 grid grid-cols-1 md:grid-cols-2 justify-between items-center'>
                <div className="banner-left">
                    ...
                    <h1 className=' text-6xl md:text-7xl mt-10 font-extrabold'>Supercharge Your Digital Workflow</h1>
                   ...
                   <div className="mt-11 flex flex-col sm:flex-row items-center gap-4 justify-center sm:justify-start">
                        <button className='btn text-white rounded-4xl bg-linear-to-r from-[#4f39f6] to-[#9514fa]'>Explore Products</button>
                        <button className='btn border md:ml-4 border-[#9514fa] rounded-4xl text-[#9514fa]'><CiPlay1 /> Watch Demo</button>
                   </div>
                </div>
